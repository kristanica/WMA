...
include_once "php/CRUD/login.php";
?>
    ...
    <main class="w-[25%]">
        ...
        <form method="post" class=" bg-[#1d171c] rounded-xl mt-2 p-2 border-yellow-400/40 border">
            ...
            <div class="text-center">
                <button type="submit" name="login" class="bg-yellow-400 text-[#1c151a] px-6 py-2 rounded-lg hover:bg-yellow-500 font-semibold transition">LOGIN</button>
            </div>
        </form>
